...
<required_reading>
@~/.gemini/antigravity/get-shit-done/references/verification-overrides.md
...
@~/.gemini/antigravity/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@~/.gemini/antigravity/get-shit-done/references/few-shot-examples/verifier.md
...
```bash
ROADMAP_DATA=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" roadmap analyze --raw)
```
