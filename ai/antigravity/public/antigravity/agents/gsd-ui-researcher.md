...
Use template from `~/.gemini/antigravity/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `~/.gemini/antigravity/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
