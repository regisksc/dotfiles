...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = ~/.gemini/antigravity/get-shit-done
                  → writes to ~/.gemini/antigravity/get-shit-done/hooks/
...
@~/.gemini/antigravity/get-shit-done/references/thinking-models-debug.md
...
- Read @~/.gemini/antigravity/get-shit-done/references/common-bug-patterns.md
...
```bash
node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
