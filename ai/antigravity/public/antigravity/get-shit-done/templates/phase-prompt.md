...
<!-- For checkpoint task examples and patterns, see @~/.gemini/antigravity/get-shit-done/references/checkpoints.md -->
...
See `~/.gemini/antigravity/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `~/.gemini/antigravity/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `~/.gemini/antigravity/get-shit-done/workflows/verify-phase.md` for verification logic.
