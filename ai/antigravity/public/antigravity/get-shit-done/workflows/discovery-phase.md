...
See ~/.gemini/antigravity/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.gemini/antigravity/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.gemini/antigravity/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.gemini/antigravity/get-shit-done/templates/discovery.md
...
Use ~/.gemini/antigravity/get-shit-done/templates/discovery.md.
