...
```bash
INIT=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
AGENT_SKILLS_EXECUTOR=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-executor 2>/dev/null)
AGENT_SKILLS_CHECKER=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-checker 2>/dev/null)
AGENT_SKILLS_VERIFIER=$(node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-verifier 2>/dev/null)
```
...
node "$HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
