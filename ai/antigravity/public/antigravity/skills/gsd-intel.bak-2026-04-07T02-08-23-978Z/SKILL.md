...
Intel system is disabled. To activate:
  ...
  node $HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node $HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node $HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node $HOME/.gemini/antigravity/get-shit-done/bin/gsd-tools.cjs intel diff
```
